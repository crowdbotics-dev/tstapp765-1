"""
Django settings for tstapp765_1 project.
...
WSGI_APPLICATION = 'tstapp765_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "tstapp765 Support <support@tstapp765-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tstapp765_1 API",
    "DESCRIPTION": "API documentation for tstapp765_1 App",
    "VERSION": "v1",
}
